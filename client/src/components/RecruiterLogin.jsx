    ...
    >
      ...
      >
        <div className="relative overflow-hidden bg-white rounded-3xl shadow-2xl">
          ...
          <div className="relative h-32 bg-gradient-to-br from-[#0b1220] to-[#2b1f1a] flex items-center justify-center">
            ...
            <div className="absolute -bottom-12 flex items-center justify-center w-24 h-24 rounded-full bg-white shadow-lg p-1">
              <div className="flex items-center justify-center w-full h-full bg-gradient-to-br from-[#ff5c2a] to-[#ffb39b] rounded-full">
            ...
            >
                ...
                <>
                  {state !== "Login" && (
                    <div className="space-y-1.5">
                      ...
                      <input
                        id="company-name"
                        className="w-full px-4 py-3 bg-gray-50 border border-[#d7cec0] rounded-xl text-[#0b1220] focus:outline-none focus:ring-2 focus:ring-[#ff5c2a]/30 focus:border-[#ff5c2a] transition-all placeholder:text-[#8c8376]"
                        value={name}
              ...
              {state === "Login" && (
                <div className="flex justify-end">
                  <button
                    type="button"
                    className="text-sm font-medium text-[#ff5c2a] hover:text-[#e74a1f] transition-colors"
                  >
                    Forgot password?
                  </button>
                </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="relative w-full py-3.5 mt-4 font-semibold transition-all btn-primary rounded-xl focus:outline-none focus:ring-2 focus:ring-[#ff5c2a]/30 focus:ring-offset-2 shadow-md hover:shadow-lg disabled:opacity-70"
              >
                {isLoading ? (
