  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        ...
        { title, description, location, category, level, salary, companyWebsite, workType, openings, lastDate },
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-10">
        ...
        <div className="h-2 bg-[#e7ddcf] rounded-full overflow-hidden">
          <div 
      ...
      <form onSubmit={onSubmitHandler} className="relative">
        ...
        >
          <div className="surface-panel rounded-2xl p-8 mb-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">Students can click this link to view your company profile</p>
              </div>
            </div>
          </div>
        ...
        >
          <div className="surface-panel rounded-2xl p-8 mb-6">
            ...
            <div className="space-y-6">
              <div className="p-6 border border-dashed border-[#d7cec0] rounded-xl bg-[#f2eadf]">
