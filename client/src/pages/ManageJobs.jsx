...
const ManageJobs = () => {
  ...
  if (jobs && jobs.length === 0) {
    return (
      <div className="flex items-center justify-center h-[70vh] surface-panel rounded-2xl">
    ...
    >
      <div className="container p-4 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="surface-panel rounded-2xl p-5 border-l-4 border-primary">
            <p className="text-gray-500 text-sm mb-1">Total Jobs</p>
            <p className="text-2xl font-bold text-primary">{jobs.length}</p>
          </div>
          <div className="surface-panel rounded-2xl p-5 border-l-4 border-green-500">
            <p className="text-gray-500 text-sm mb-1">Active Jobs</p>
            <p className="text-2xl font-bold text-green-600">
              {jobs.filter(job => job.visible).length}
            </p>
          </div>
          <div className="surface-panel rounded-2xl p-5 border-l-4 border-blue-500">
        ...
        <div className="surface-panel rounded-2xl overflow-hidden mb-6">
          <div className="overflow-x-auto w-full">
            <table className="w-full text-primary">
              <thead className="bg-[#f2eadf] border-b">
                <tr>
